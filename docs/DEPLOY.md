...
- Fill the placeholders in `packages/shared/src/legal.ts` (name, address, contact email, hosting regions, governing law) and rebuild; the pages are served at `/privacy` and `/terms`.
